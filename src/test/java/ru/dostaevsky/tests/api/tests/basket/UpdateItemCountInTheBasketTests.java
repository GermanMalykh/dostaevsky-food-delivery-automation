...
import static ru.dostaevsky.tests.api.constants.FilePathConstants.UPDATE_ITEM_COUNT_IN_THE_BASKET_JSON;
...
public class UpdateItemCountInTheBasketTests extends ApiConfig {
    ...
    UpdateItemCountInBasketRequest updateCountInBasket = JsonConverter.deserialize(new File(UPDATE_ITEM_COUNT_IN_THE_BASKET_JSON), UpdateItemCountInBasketRequest.class);
